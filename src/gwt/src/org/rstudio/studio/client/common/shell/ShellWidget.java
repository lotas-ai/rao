                                                      ...
                                                      ConsoleError.Observer
{
   ...
   public String getConsoleOutputContent()
   {
      if (output_ != null)
      {
         return output_.getConsoleContent();
      }
      return "";
   }

   public static native String getGlobalConsoleContent() /*-{
      try {
         // Try to get the console output element directly from DOM
