                                  ...
                                  WebApplicationHeaderOverlay.Context
{
                  ...
                  Provider<CodeSearch> pCodeSearch)
   {
      ...
      // Add 8px left margin to simulate the standard padding since we removed the logo
      mainMenu_.getElement().getStyle().setMarginLeft(8, Unit.PX);
   ...
   public void showToolbar(boolean showToolbar)
   {
      ...
      if (showToolbar)
      {
         ...
         // Add left margin to the header panel for proper alignment
         headerPanel.getElement().getStyle().setMarginLeft(8, Unit.PX);
      ...
      else
      {
         ...
         // Add left margin to the menubar panel for proper alignment
         menubarPanel.getElement().getStyle().setMarginLeft(8, Unit.PX);
