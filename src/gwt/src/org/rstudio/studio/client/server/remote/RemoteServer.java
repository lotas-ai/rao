...
@Singleton
public class RemoteServer implements Server, AiServerOperations
{
   @Inject
   ...
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(script));
      params.set(1, new JSONNumber(messageId));
      sendRequest(RPC_SCOPE, RUN_SCRIPT_IN_CONSOLE, params, requestCallback);
   }
   
   public void runScriptInTerminal(String script, int messageId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(script));
      params.set(1, new JSONNumber(messageId));
      sendRequest(RPC_SCOPE, RUN_SCRIPT_IN_TERMINAL, params, requestCallback);
   }
   
   public void clearConsoleDoneFlag(int messageId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      sendRequest(RPC_SCOPE, CLEAR_CONSOLE_DONE_FLAG, messageId, requestCallback);
   }

   public void checkTerminalComplete(int messageId, ServerRequestCallback<Boolean> requestCallback)
   {
      // Wrap the original callback to add debugging
      ServerRequestCallback<Boolean> debugCallback = new ServerRequestCallback<Boolean>() {
         @Override
      ...
      sendRequest(RPC_SCOPE, CHECK_TERMINAL_COMPLETE, messageId, debugCallback);
   }
   
   public void finalizeConsoleCommand(int messageId, String requestId, String consoleOutput, ServerRequestCallback<JavaScriptObject> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONNumber(messageId));
      if (requestId != null && !requestId.isEmpty()) {
         params.set(1, new JSONString(requestId));
      }
      if (consoleOutput != null) {
         params.set(2, new JSONString(consoleOutput));
      } else {
         params.set(2, new JSONString(""));
      }
      sendRequest(RPC_SCOPE, FINALIZE_CONSOLE_COMMAND, params, requestCallback);
   }

   public void finalizeTerminalCommand(int messageId, String requestId, ServerRequestCallback<JavaScriptObject> requestCallback)
   {
      // Wrap the original callback to add debugging
      ServerRequestCallback<JavaScriptObject> debugCallback = new ServerRequestCallback<JavaScriptObject>() {
         @Override
      ...
      sendRequest(RPC_SCOPE, FINALIZE_TERMINAL_COMMAND, params, debugCallback);
   }

   public void clearTerminalDoneFlag(int messageId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
   ...
   {
      sendRequest(RPC_SCOPE, REVERT_AI_MESSAGE, messageId, requestCallback);
   }
      
   @Override
   public void listConversations(ServerRequestCallback<JsArrayString> requestCallback)
   {
      sendRequest(RPC_SCOPE, LIST_CONVERSATIONS, requestCallback);
   }

   @Override
   public void getCurrentConversationIndex(ServerRequestCallback<Double> requestCallback)
   {
      sendRequest(RPC_SCOPE, "get_current_conversation_index", requestCallback);
   }
   ...
   @Override
   public void saveApiKey(String provider, String key, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(provider));
      params.set(1, new JSONString(key));
      sendRequest(RPC_SCOPE, SAVE_API_KEY, params, requestCallback);
   }
   
   @Override
   public void deleteApiKey(String provider, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      sendRequest(RPC_SCOPE, DELETE_API_KEY, provider, requestCallback);
   }
   
   @Override
   public void setActiveProvider(String provider, ServerRequestCallback<java.lang.Void> requestCallback)
   {
                              ...
                              ServerRequestCallback<java.lang.Void> requestCallback)
   {
      ...
      sendRequest(RPC_SCOPE, SAVE_AI_ATTACHMENT, params, requestCallback);
   }

   public void switchConversation(int index)
   {
      sendRequest(RPC_SCOPE, SWITCH_CONVERSATION, index, null);
   }
   ...
   @Override
   public void replayNotebookChunkPlots(String docId,
                                        String chunkId,
                                        int pixelWidth,
                                        int pixelHeight,
                                        ServerRequestCallback<String> requestCallback)
                                   ...
                                   ServerRequestCallback<JsArray<LintItem>> requestCallback)
   {
      ...
      params.set(2, new JSONString(content));
      params.set(3, JSONBoolean.getInstance(showMarkersPane));
      params.set(4, JSONBoolean.getInstance(explicit));
   ...
   public void cppSourceFile(String path, ServerRequestCallback<Void> requestCallback) 
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(path));
      sendRequest(RPC_SCOPE, CPP_SOURCE_FILE, params, requestCallback);
   }
   ...
   private static final String CREATE_NEW_CONVERSATION = "create_new_conversation";
   private static final String RUN_SCRIPT_IN_TERMINAL = "run_script_in_terminal";
   private static final String RUN_SCRIPT_IN_CONSOLE = "run_script_in_console";
   private static final String CLEAR_CONSOLE_DONE_FLAG = "clear_console_done_flag";
   private static final String CHECK_TERMINAL_COMPLETE = "check_terminal_complete";
   private static final String FINALIZE_CONSOLE_COMMAND = "finalize_console_command";
   private static final String FINALIZE_TERMINAL_COMMAND = "finalize_terminal_command";
   private static final String CLEAR_TERMINAL_DONE_FLAG = "clear_terminal_done_flag";
   private static final String REVERT_AI_MESSAGE = "revert_ai_message";

   private static final String LIST_CONVERSATIONS = "list_conversations";
   private static final String GET_CURRENT_CONVERSATION_INDEX = "get_current_conversation_index";
   ...
   private static final String DELETE_CONVERSATION_NAME = "delete_conversation_name";
   private static final String LIST_CONVERSATION_NAMES = "list_conversation_names";
   private static final String SHOULD_PROMPT_FOR_NAME = "should_prompt_for_name";
   private static final String GENERATE_CONVERSATION_NAME = "generate_conversation_name";
   private static final String GET_CONVERSATION_LOG = "get_conversation_log";

   private static final String SAVE_AI_ATTACHMENT = "save_ai_attachment";

   private static final String LIST_ATTACHMENTS = "list_attachments";
   ...
   private static final String SET_AI_WORKING_DIRECTORY = "set_ai_working_directory";
   private static final String BROWSE_DIRECTORY = "browse_directory";
   ...
   @Override
   public void getConversationName(int conversationId, ServerRequestCallback<String> requestCallback)
   {
      sendRequest(RPC_SCOPE, GET_CONVERSATION_NAME, conversationId, requestCallback);
   }

   @Override
   public void setConversationName(int conversationId, String name, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONNumber(conversationId));
      params.set(1, new JSONString(name));
      sendRequest(RPC_SCOPE, SET_CONVERSATION_NAME, params, requestCallback);
   }

   @Override
   public void deleteConversationName(int conversationId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      sendRequest(RPC_SCOPE, DELETE_CONVERSATION_NAME, conversationId, requestCallback);
   }

   @Override
   public void listConversationNames(ServerRequestCallback<ConversationNamesResult> requestCallback)
   {
      sendRequest(RPC_SCOPE, LIST_CONVERSATION_NAMES, requestCallback);
   }

   @Override
   public void shouldPromptForName(ServerRequestCallback<Boolean> requestCallback)
   {
      sendRequest(RPC_SCOPE, SHOULD_PROMPT_FOR_NAME, requestCallback);
   }

   @Override
   public void generateConversationName(int conversationId, ServerRequestCallback<String> requestCallback)
   {
      sendRequest(RPC_SCOPE, GENERATE_CONVERSATION_NAME, conversationId, requestCallback);
   }
   
   @Override
   public void getConversationLog(int conversationId, ServerRequestCallback<org.rstudio.studio.client.workbench.views.ai.model.ConversationLogResult> requestCallback)
   {
      sendRequest(RPC_SCOPE, GET_CONVERSATION_LOG, conversationId, requestCallback);
   }

   @Override
   public void listAttachments(ServerRequestCallback<JsArrayString> requestCallback)
   {
      sendRequest(RPC_SCOPE, LIST_ATTACHMENTS, requestCallback);
   }

   @Override
   public void deleteAttachment(String filePath, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      sendRequest(RPC_SCOPE, DELETE_ATTACHMENT, filePath, requestCallback);
   }

   @Override
   public void deleteAllAttachments(ServerRequestCallback<java.lang.Void> requestCallback)
   {
      sendRequest(RPC_SCOPE, DELETE_ALL_ATTACHMENTS, requestCallback);
   }
   ...
   @Override
   public void markButtonAsRun(String messageId, String buttonType, ServerRequestCallback<Boolean> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(messageId));
      params.set(1, new JSONString(buttonType));
      sendRequest(RPC_SCOPE, MARK_BUTTON_AS_RUN, params, requestCallback);
   }

   @Override
   public void getFileNameForMessageId(String messageId, ServerRequestCallback<String> requestCallback)
   {
      sendRequest(RPC_SCOPE, GET_FILE_NAME_FOR_MESSAGE_ID, messageId, requestCallback);
   }

   @Override
   public void isConversationEmpty(int conversationId, ServerRequestCallback<Boolean> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONNumber(conversationId));
      sendRequest(RPC_SCOPE, IS_CONVERSATION_EMPTY, params, requestCallback);
   }

   @Override
   public void setAiWorkingDirectory(String dir, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      sendRequest(RPC_SCOPE, SET_AI_WORKING_DIRECTORY, dir, requestCallback);
   }

   @Override
   public void browseDirectory(ServerRequestCallback<JavaScriptObject> requestCallback)
   {
      sendRequest(RPC_SCOPE, BROWSE_DIRECTORY, requestCallback);
   }

   @Override
   public void browseForFile(ServerRequestCallback<FileSystemItem> requestCallback)
   {
      sendRequest(RPC_SCOPE, BROWSE_FOR_FILE, requestCallback);
   }

   @Override
   public void addContextItem(String path, ServerRequestCallback<Boolean> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(path));
      sendRequest(RPC_SCOPE, "add_context_item", params, requestCallback);
   }

   @Override
   public void getContextItems(ServerRequestCallback<JsArrayString> requestCallback)
   {
      sendRequest(RPC_SCOPE, "get_context_items", requestCallback);
   }

   @Override
   public void removeContextItem(String path, ServerRequestCallback<Boolean> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(path));
      sendRequest(RPC_SCOPE, "remove_context_item", params, requestCallback);
   }
   ...
   @Override
   public void getTerminalWebsocketPort(ServerRequestCallback<Double> requestCallback)
   {
      sendRequest(RPC_SCOPE, "get_terminal_websocket_port", requestCallback);
   }

   @Override
   public void getWebSocketChannelId(int port, ServerRequestCallback<String> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONNumber(port));
      sendRequest(RPC_SCOPE, "get_websocket_channel_id", params, requestCallback);
   }

   @Override
   public void getTabFilePath(String tabId, ServerRequestCallback<String> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(tabId));
      sendRequest(RPC_SCOPE, "get_tab_file_path", params, requestCallback);
   }

   @Override
   public void addContextLines(String path, int startLine, int endLine, ServerRequestCallback<Boolean> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(path));
      params.set(1, new JSONNumber(startLine));
      params.set(2, new JSONNumber(endLine));
      sendRequest(RPC_SCOPE, "add_context_lines", params, requestCallback);
   }

   @Override
   public void matchTextInOpenDocuments(String searchText, ServerRequestCallback<TextMatchResult> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(searchText));
      sendRequest(RPC_SCOPE, "match_text_in_open_documents", params, requestCallback);
   }

   @Override
   public void acceptTerminalCommand(String messageId, String script, String requestId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(messageId));
      params.set(1, new JSONString(script));
      params.set(2, new JSONString(requestId));
      sendRequest(RPC_SCOPE, "accept_terminal_command", params, requestCallback);
   }

   @Override
   public void cancelTerminalCommand(String messageId, String requestId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(messageId));
      params.set(1, new JSONString(requestId));
      sendRequest(RPC_SCOPE, "cancel_terminal_command", params, requestCallback);
   }

   @Override
   public void acceptConsoleCommand(String messageId, String script, String requestId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(messageId));
      params.set(1, new JSONString(script));
      params.set(2, new JSONString(requestId));
      sendRequest(RPC_SCOPE, "accept_console_command", params, requestCallback);
   }

   @Override
   public void cancelConsoleCommand(String messageId, String requestId, ServerRequestCallback<java.lang.Void> requestCallback)
   {
      JSONArray params = new JSONArray();
      params.set(0, new JSONString(messageId));
      params.set(1, new JSONString(requestId));
