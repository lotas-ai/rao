...
public class AiHyperlink extends Hyperlink
{
    public AiHyperlink(String url, Map<String, String> params, String text, String clazz) 
    {
    ...
    public void onClick()
    {
        server_.showAiTopic(topic_, pkg_, RCompletionType.FUNCTION);
    }
    ...
    public void getPopupContent(CommandWithArg<Widget> onReady)
    {
        ...
        panel.add(new AiHyperlinkPopupHeader(topic_, pkg_));
        panel.add(new AiPreview(topic_, pkg_, () -> 
        {
