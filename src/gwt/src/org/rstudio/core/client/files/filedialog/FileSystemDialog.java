                 ...
                 FileBrowserWidget.Host
{
   ...
   /**
    * Adds a note widget to the dialog content panel
    * @param widget The widget to add (typically a Label)
    */
   protected void addNoteWidget(Widget widget)
   {
      if (widget != null)
      {
         widget.addStyleName("dialog-note");
         addWidget(widget);
      }
   }
   ...
   {
      if (browser_ != null && widget != null)
      {
         mainPanel_.insert(widget, mainPanel_.getWidgetIndex(browser_));
      }
   }
}
