                 ...
                 implements FileSystemContext.Callbacks
{
   ...
   // Method to track whether user double-clicked
   public boolean hasDoubleClicked() {
      boolean result = doubleClicked_;
      doubleClicked_ = false;  // Reset after checking
      return result;
   }

   // Method to set double-clicked flag
   public void setDoubleClicked(boolean value) {
      doubleClicked_ = value;
   }
   ...
   private Host host_;
   private boolean doubleClicked_ = false;  // Track double-click status
}
