...
public class PreAiSearchWidget extends Composite implements SearchDisplay
{
   interface MyUiBinder extends UiBinder<Widget, PreAiSearchWidget> {}
   ...
   public PreAiSearchWidget(String label)
   {
   ...
   public PreAiSearchWidget(String label, SuggestOracle oracle)
   {
         ...
         public void onKeyDown(KeyDownEvent event)
         {
            ...
            case KeyCodes.KEY_ENTER:
               Scheduler.get().scheduleDeferred(new ScheduledCommand() {
                  public void execute()
                  {
                     SelectionCommitEvent.fire(PreAiSearchWidget.this,
                                               suggestBox_.getText());
                  }
               });
               break;
            case KeyCodes.KEY_ESCAPE:
               ...
               Scheduler.get().scheduleDeferred(new ScheduledCommand() {
                  ...
                  public void execute()
                  {
                     ...
                     {
                        CloseEvent.fire(PreAiSearchWidget.this, PreAiSearchWidget.this);
                     }
                  }
               });
         ...
         suggestBox_.addKeyUpHandler(new KeyUpHandler() {
            public void onKeyUp(KeyUpEvent event)
            {
               ...
               if (value != lastValueSent_)
               {
                  ...
                  ValueChangeEvent.fire(PreAiSearchWidget.this, value);
               }
            }
         });
      }
      ...
      suggestBox_.addValueChangeHandler(new ValueChangeHandler<String>()
      {
         public void onValueChange(ValueChangeEvent<String> evt)
         {
            if (evt.getValue() != lastValueSent_)
            {
               ...
               delegateEvent(PreAiSearchWidget.this, evt);
            }
         }
      });
   ...
   public void clear()
   {
      // Try multiple approaches to ensure the text is actually cleared from the UI
      suggestBox_.setText("");
      suggestBox_.setValue("", true);
      
      // Force focus and blur to trigger UI update
      boolean wasFocused = isFocused();
      if (wasFocused) {
         suggestBox_.getValueBox().getElement().blur();
