...
exports.AnthropicProxyService = void 0;
...
class AnthropicProxyService {
    constructor() {
        this.cancellationService = new Set();
    ...
    handleContentBlockStart(data, state, _originalRequest) {
        if (!data.content_block || data.index === undefined)
            return;
...
exports.AnthropicProxyService = AnthropicProxyService;
//# sourceMappingURL=anthropicProxyService.js.map