...
// details of a socket connection
struct ConsoleProcessSocketConnectionDetails
{
   ConsoleProcessSocketConnectionDetails()
   {
   }
...
// access to singleton
extern ConsoleProcessSocket& processSocket();

// access to the socket port (for WebSocket communications)
